  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="出库编码" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="code">
              <a-input v-model="model.code" placeholder="请输入出库编码" :disabled="true"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
            <a-form-model-item label="客户" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="customer">
              <j-dict-select-tag type="list" v-model="model.customer" dictCode="customer" placeholder="请选择客户" />
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-model-item label="出库数量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="qty">
              <a-input-number v-model="model.qty" placeholder="请输入出库数量" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
            <a-form-model-item label="出货仓库" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="stock">
              <j-dict-select-tag type="list" v-model="model.stock" dictCode="warehouse" placeholder="请选择出货仓库" />
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/goods_stock_out/erpStockOut/add",
          edit: "/goods_stock_out/erpStockOut/edit",
          queryById: "/goods_stock_out/erpStockOut/queryById",
          getSerialNo: "/goods_stock_out/erpStockOut/getSerialNo",
        ...
        getAction(this.url.getSerialNo).then((res)=>{
          if(res.success){
            if(typeof res.result == 'string' && res.result.length > 0){
              ...
              that.model.code = 'CHD-' + getCurrentDate('yyMMdd') + '-001';
            }
          }else{
